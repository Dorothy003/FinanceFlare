    ...
    <div className="w-screen h-screen flex overflow-hidden">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-8 bg--[#f1f3ff]">
        <div className="w-full max-w-md">
          ...
          <button className="w-full py-2 bg-gradient-to-r from-purple-500 to-blue-400 text-white font-bold rounded-full shadow-md hover:shadow-lg transition cursor-pointer">
            LOGIN
          </button>
